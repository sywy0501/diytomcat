...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb","/Users/chushi/develop/IdeaProjects/javaweb/web",null,true);
            File file = new File("/Users/chushi/develop/IdeaProjects/javaweb/web/index.jsp");
